  ...
  return (
    <div className="w-[50%] h-full flex justify-center items-center z-20 overflow-y-scroll">
      <div className="relative w-[70%] h-[52%] p-18 bg-subsub text-center rounded-xl shadow-lg shadow-blue-500/50">
        <div className="text-7xl mb-10 text-shadow whitespace-nowrap">Auto Page</div>
        <h1 className="text-3xl whitespace-nowrap">Download App</h1>
        <p className="my-10 text-xl whitespace-nowrap">Click the button! start your download.</p>
